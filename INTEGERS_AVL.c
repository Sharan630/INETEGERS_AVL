...
int main() {
    ...
    while (choice != 0) {
        ...
        switch (choice) {
            int n;
        case 1:
            printf("Enter the integer to insert into Set 1: ");
            scanf("%d", &num);
            root1 = insert(root1, num);
            printf("The integer %d is inserted into Set 1\n", num);
            break;
        case 2:
            printf("Enter the integer to insert into Set 2: ");
            scanf("%d", &num);
            root2 = insert(root2, num);
            printf("The integer %d is inserted into Set 2\n", num);
            break;
        case 3:
            printf("Enter the integer to delete from Set 1: ");
            scanf("%d", &num);
            root1 = delete(root1, num);
            printf("The integer %d is deleted from Set 1\n", num);
            display_inorder(root1);
            break;
        case 4:
            printf("Enter the integer to delete from Set 2: ");
            scanf("%d", &num);
            root2 = delete(root2, num);
            printf("The integer %d is deleted from Set 2\n", num);
            display_inorder(root2);
            break;
        case 5:
            printf("Enter the integer to emplace into Set 1: ");
            scanf("%d", &num);
            emplace(root1, num);
            break;
        case 6:
            printf("Enter the integer to emplace into Set 2: ");
            scanf("%d", &num);
            emplace(root2, num);
            break;
        case 7:
            ...
            if (find(root1, n) != NULL)
                printf("Key '%d' is found in Set 1\n", n);
            else
                printf("Key '%d' is not found in Set 1\n", n);

            if (find(root2, n) != NULL)
                printf("Key '%d' is found in Set 2\n", n);
            else
                printf("Key '%d' is not found in Set 2\n", n);
            break;
        case 8:
            empty(root1);
            break;
        ...
        case 11:
            ...
            break;
        case 12:
            printf("First element of set-1 is %d\n", (begin(root1)->key));
            printf("First element of set-2 is %d\n", (begin(root2)->key));
            break;
        case 13:
            printf("Last element of set-1 is %d\n", (end(root1)->key));
            printf("Last element of set-2 is %d\n", (end(root2)->key));
            break;
        case 14:
            clear(root1);
            clear(root2);
...
void emplace(struct node* root, int key) {
    struct node* node = find(root, key);
    if (node == NULL) {
        root = insert(root, key); 
    } else {
        printf("The integer %d is already present in the set.\n", key);
    }
}
